...
public protocol CommitStorage: AnyObject
{
  ...
  associatedtype RevWalk: XitGit.RevWalk
...
public protocol CommitReferencing: AnyObject
{
  ...
  associatedtype Tree: XitGit.Tree
  associatedtype LocalBranch: XitGit.LocalBranch
...
{
  associatedtype Blame: XitGit.Blame
...
{
  associatedtype Blob: XitGit.Blob
...
{
  associatedtype Remote: XitGit.Remote
