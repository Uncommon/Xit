...
@Suite
struct BitbucketServiceTests
{
  private func makeService(mock: MockNetworkService) -> BitbucketService
  {
    ...
    return BitbucketService(account: account,
                                password: "pw",
  ...
  func getPullRequestsDecodesAndSetsFields() async throws
  {
    ...
    let pr = try #require(prs.first as? BitbucketService.BitbucketPR)
  ...
  func approveAndStateUpdatesSendPutWithPayload() async throws
  {
    ...
    #expect(approveBody["status"] as? String == BitbucketService.ReviewerStatus.approved.rawValue)
    ...
    #expect(unapproveBody["status"] as? String == BitbucketService.ReviewerStatus.unapproved.rawValue)
    ...
    #expect(needsWorkBody["status"] as? String == BitbucketService.ReviewerStatus.needsWork.rawValue)
  }
