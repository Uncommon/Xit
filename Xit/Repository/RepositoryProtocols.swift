...
public class FakeCommitReferencing<
    ...
    RemoteBranch: Xit.RemoteBranch>: CommitReferencing
{
...
public protocol FileContents: AnyObject
{
  ...
  func contentsOfFile(path: String, at commit: any Xit.Commit) -> Data?
...
public protocol Branching: AnyObject
{
  ...
  func reset(toCommit target: any Xit.Commit, mode: ResetMode) throws
}
